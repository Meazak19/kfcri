...
function initMobileMenu() {
  ...
  /* LEVEL 1 */
  document.querySelectorAll('.mobile-nav .has-m-sub > a').forEach(link => {

    link.addEventListener('click', function(e) {

      const submenu = this.nextElementSibling;

      if (submenu && submenu.classList.contains('m-sub')) {
        e.preventDefault();
  ...
  /* LEVEL 2 */
  document.querySelectorAll('.mobile-nav .has-m-sub2 > a').forEach(link => {

    link.addEventListener('click', function(e) {

      const submenu = this.nextElementSibling;

      if (submenu && submenu.classList.contains('m-sub2')) {
        e.preventDefault();
